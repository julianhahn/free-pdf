...
| 6 | **done** on 2026-08-18 ([`TASKS.md`](./TASKS.md) 32) - the pages screen carries both actions as controls under the carousel: Adjust page, and Shoot another page dead until the scan is finished. The "…" menu is retake and delete only. [`TASKS.md`](./TASKS.md) 33 to 35 are the rest of the camera work and are still open. | client agent |
