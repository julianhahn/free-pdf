...
| `flows/brand/app-icon.svg`, `flows/brand/app-icon-tinted.svg` | The decided app icon (6c) as delivered, and `flows/FreePDF App Icon.dc.html` is the document that decided it. |
